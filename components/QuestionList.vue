            ...
            <div class="col-4">
                <div class="card" style="color: black;">
                    <div class="card-header">
                        <h1 style="font-family: 'Times New Roman', sans-serif;font-weight: bold;">Insert A Question</h1>
                    </div>
                    <div class="card-body" style="background-color: #ddddff;">
                        <hr>
                        <div class="row d-flex flex-column align-items-xxl-center">
                            <div class="col"><label class="col-form-label" style="font-family: 'Times New Roman', sans-serif;font-weight: bold;font-size: 23px;">Question</label></div>
                        ...
                        <div class="row d-flex flex-column align-items-xxl-center">
                            <div class="col"><label class="col-form-label" style="font-family:'Times New Roman', sans-serif;font-weight: bold;font-size: 23px;">Choice A</label></div>
                            <div class="col d-flex justify-content-xxl-center align-items-xxl-center" style="padding-left: 45px;">
                        ...
                        <div class="row d-flex flex-column align-items-xxl-center">
                            <div class="col"><label class="col-form-label" style="font-family:'Times New Roman', sans-serif;font-weight: bold;font-size: 23px;">Choice B</label></div>
                            <div class="col d-flex justify-content-xxl-center align-items-xxl-center" style="padding-left: 45px;">
                        ...
                        <div class="row d-flex flex-column align-items-xxl-center">
                            <div class="col"><label class="col-form-label" style="font-family:'Times New Roman', sans-serif;font-weight: bold;font-size: 23px;">Answer Key</label></div>
                    ...
                    <div class="card-footer">
                        <div class="row" >
                            <div class="col-6 d-flex justify-content-xxl-end align-items-xxl-center" style="padding-right: 35px;padding-left: 35px;">
                                <button class="btn btn-primary" id="ResetBtn" @click="ResetInput()" data-bss-hover-animate="shake" type="button" style="font-family: Aboreto, serif;font-weight: bold;background: blue;text-align: center;width: 208px;border-style: none; ">Reset</button>
                            </div>
                            <div class="col-6 d-flex justify-content-xxl-start align-items-xxl-center" v-if="!edit" style="padding-right: 35px;padding-left: 35px;">
                                <button class="btn btn-primary" id="InsertBtn" @click="InsertClick()" data-bss-hover-animate="pulse" type="submit" style="background: blue; font-family: Aboreto, serif;font-weight: bold;text-align: center;width: 208px;border-style: none;">Insert</button>
                            </div>
                    ...
                    <div class="col" style="color: white !important;">
                        <b-table id="MongoTable"  sticky-header="70vh" style="overflow-x: hidden; color: white;" head-variant="light" no-border-collapse borderless :items="items" :fields="fields" class="mytable">
                            ...
                            <template v-slot:cell(actions)="{ item, index }">
                                <div class="row">
                                    <div class="col">
                                        <b-button v-b-tooltip.hover title="Delete User" @click="DeleteClick(item)" variant="warning">Delete</b-button>
                                    </div>
                                    <div class="col">
                                        <b-button v-b-tooltip.hover title="Edit User Info" @click="EditClick(item, index)" variant="info">Edit</b-button>
                                    </div>
                                </div>
                            </template>
                        </b-table>
